	...
	<div class="retailList" :class="{tableHeight: isExist,tabHeight: !isExist}" v-loading="loading">
		...
		<el-dialog title="" class="historyDialog" :visible.sync="dialogVisible" width="90%" :before-close="handleClose">
			...
			<div class="dialogContent" v-loading="tradeLoading">
				<el-table :data="tradeTable" ref="retailTradeTable" style="width: 100%" stripe border height="450">
...
export default {
	...
	methods: {
		...
		scrollToLeft(){
			this.$nextTick( () => {
				let tableObj = this.$refs.retailTradeTable.$el.getElementsByClassName('el-table__body-wrapper')[0];
